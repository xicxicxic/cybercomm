  ...
  public render(): JSX.Element {
    const panels = [
      {
        ...
        content: {
          key: "sent",
          content: <DraftMessages></DraftMessages>,
        },
      },
      {
    ...
    return (
      <Flex className="tabContainer" column fill gap="gap.small">
        ...
        <Flex className="settingsBtn" hAlign="end" vAlign="end">
          <Button
            content={this.localize("Settings")}
...
export default connect(mapStateToProps, { getDraftMessagesList })(
