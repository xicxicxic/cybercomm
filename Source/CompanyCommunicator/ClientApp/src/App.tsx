...
import SettingsH from "./components/Settings/SettingsH";
import "./App.scss";
import {
  Provider,
  teamsTheme,
          ...
          <div className="appContainer">
            ...
            <BrowserRouter>
              <Switch>
                ...
                <Route exact path="/settings" component={SettingsH} />
                <Route exact path="/newmessage/:id" component={NewMessage} />
                <Route
                  exact
                  path="/viewstatus/:id"
                  component={StatusTaskModule}
                />
                <Route
                  exact
                  path="/sendconfirmation/:id"
                ...
                <Route
                  ...
                  component={SignInSimpleStart}
                />
                <Route
                  exact
                  path="/signin-simple-end"
                  component={SignInSimpleEnd}
                />
              </Switch>
            </BrowserRouter>
          </div>
