...
class NewMessage extends React.Component<INewMessageProps, formState> {
  ...
  private onGroupSelected = (event: any, data: any) => {
    this.setState({
      ...
      selectedTeamsNum:
        data.value === "teams" ? this.state.selectedTeamsNum : 0,
      selectedRosters:
        data.value === "rosters" ? this.state.selectedRosters : [],
      selectedRostersNum:
        data.value === "rosters" ? this.state.selectedRostersNum : 0,
      selectedGroups: data.value === "groups" ? this.state.selectedGroups : [],
      selectedGroupsNum:
        data.value === "groups" ? this.state.selectedGroupsNum : 0,
    });
  };
